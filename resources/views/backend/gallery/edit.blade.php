            ...
            <div class="card border_dark">
                <div class="card-header border_bottom bg_soft_dark">
                    <div class="row card-title">
                        <div class="col-md-6">
                            <h5 class="mb-0 pt-2 text-primary">Gallery Edit</h5>
                        </div>
                ...
                <div class="card-body">
                    <form action="{{ route('gallery_update', $data->uuid) }}" method="POST" enctype="multipart/form-data">
                        @CSRF
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-2">
                                <div class="mb-3 position-relative">
                                    ...
                                    <img src="{{ file_exists(public_path('images/gallery/'.$data->image)) ? asset('images/gallery/' . $data->image) : '' }}" alt="Gallery Image"
